...
```
docker load --input <nombreArchivo.rar>
```

Éste comando permite cargar una imagen desde un archivo.rar
...
En el caso de linux puedes probar:
```
docker load -i <nombre-de-archivo.tar>
```

Esto Permite cargar una imagen desde un archivo tar.
